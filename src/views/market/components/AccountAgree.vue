...
export default {
  data() {
    return {
      flag: [],
      hrefgo: 'https://support.newdex.net/hc/en-us/articles/360012588791-User-Agreement',
    }
  },
  components: {
  ...
  methods: {
    ...
    handleFormatLang(val) {
      this.hrefgo = 'https://support.newdex.net/hc/en-us/articles/360012588791-User-Agreement';
      if (val === 'zh-TW') {
        this.hrefgo = 'https://support.newdex.net/hc/zh-tw/articles/360012588791-%E4%BD%BF%E7%94%A8%E5%8D%94%E8%AD%B0-';
      }
      if (val === 'zh-CN') {
        this.hrefgo = 'https://support.newdex.net/hc/zh-cn/articles/360012588791-%E4%BD%BF%E7%94%A8%E5%8D%8F%E8%AE%AE';
      }
    },
    /* -------- 权限校验 start -------- */
    // 获取服务器时间戳
