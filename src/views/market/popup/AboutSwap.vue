<template>
  <div class="tipEosSell">
    ...
    <div class="content">
      <div class="tip">{{ $t('marketDistribution.tip1') }}</div>
      <div class="tip">{{ $t('marketDistribution.tip2') }}</div>
      <div class="tip">{{ $t('marketDistribution.tip3') }}</div>
    </div>
    <div class="btnDiv">
      <div class="btn" @click="handleClose">{{ $t('public.sure') }}</div>
    </div>
  </div>
</template>
